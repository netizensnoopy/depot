...
{
    rb_cQMimeData =
        // RubyQt6::QtGui::QMimeData
        define_qlass_under<QMimeData, QObject>(rb_mQt6QtGui, "QMimeData")
            // Public Functions
            .define_method("formats", &QMimeData::formats)
            .define_method("has_text", &QMimeData::hasText)
            .define_method("has_urls", &QMimeData::hasUrls)
            .define_method("text", &QMimeData::text)
            .define_method("urls", &QMimeData::urls);
